...
const Footer = () => {
  return (
    <div className="pt-16 pb-16">
      <div className="w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-5">
          ...
          <div className="mt-6">
            <h1 className="text-sm text-gray-600">Our Mobile Numbers</h1>
