    ...
    <div className="relative w-full h-[120vh] sm:h-[100vh]">
      ...
      <div className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex items-center justify-center flex-col w-full h-full">
          <div>
            <h1 className="text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] tracking-[.7rem] text-white font-bold uppercase">
              Lets enjoy the Nature
            </h1>
            <p className="md:text-base text-center text-lg text-white font-normal [word-spacing:5px]">
              Get the best prices on 200.000+ properties, worldwide.
            </p>
          </div>
          <SearchBox />
          <Link
