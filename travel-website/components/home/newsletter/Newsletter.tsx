  ...
  return (
    <div className="bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col">
      ...
      <p className="mt-3 text-white text-xs sm:text-sm">
        Sign Up and we'll send the best deals, news and tips to you{" "}
      </p>
      <div className="w-full">
        <input
          ...
          placeholder="Email"
        />
        <button className="px-6 py-3.5 bg-blue-900 hover:bg-blue-950 transition-all duration-200 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none">Subscribe</button>
      </div>
    </div>
  );
};
